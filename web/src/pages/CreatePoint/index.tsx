...
const CreatePoint = ()=>{
    ...
    const [items, setItems] = useState<Item[]>([]);  //p indicar que é um array com vários Item
                    ...
                    <Map center={initialPosition} zoom={15} onClick={handleMapClick}>
                        ...
                        <div className="field-group">
                            <div className="field">
                                ...
                                <select name="uf" id="uf" value={selectedUf} required onChange={handleSelectUf}>
                            ...
                            <div className="field">
                                ...
                                <select name="city" id="city" value={selectedCity} required onChange={handleSelectCity}>
